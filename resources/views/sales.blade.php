...
<body>
    ...
    <div id="top">
        <div class="container">
            <div class="col-md-6 offer" data-animate="fadeInDown">
                <a href="#" class="btn btn-success btn-sm" data-animate-hover="shake">Offer of the day</a>  <a href="#">Get flat 35% off on /salesdetail over $50!</a>
            </div>
            ...
            <div class="modal-dialog modal-sm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="customer-/salesdetail.html" method="post">
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9" id="customer-/salesdetail">
                    <div class="box">
                        <h1>My sales</h1>

                        <p class="lead">Your sales on one place.</p>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="/salesdetail" class="btn btn-primary btn-sm">View</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th># 1735</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>22/06/2013</td>
                                        <td>$ 150.00</td>
                                        <td><span class="label label-success">Sent</span>
                                        </td>
                                        <td><a href="/salesdetail" class="btn btn-primary btn-sm">View</a>
                                        </td>
                                    </tr>
